...
const Skills = () => {
    return (
        <section id="skills" className=' px-5  md:py-20  py-10 bg-gray-100 w-full' >
            <div className="container m-auto flex  md:flex-row flex-col gap-10 bg-grey-50 " >
                ...
                <div className=' flex-col flex gap-5 md:w-[30%]' >
                    ...
                    <div className=' flex-col flex gap-2' >
                        <div className='flex justify-between font-semibold '>
                            <div>React js</div>
                            <div className='text-blue-800' >60%</div>
                        </div>
                        <div className='bg-gray-200  rounded-full  w-full' >
                            <div className='w-[60%] bg-blue-800    h-2 md:h-3 rounded-full ' />
                        </div>
                    </div>
                    <div className=' flex-col flex gap-2' >
                        <div className='flex justify-between font-semibold '>
