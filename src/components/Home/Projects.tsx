                ...
                <div className='grid  grid-cols-1 md:grid-cols-3 gap-10  ' >
                    ...
                    <div className=" border GlassCard h-full    rounded-md overflow-hidden">
                        ...
                        <div className=' p-5 ' >
                            ...
                            <h1 className="title-font text-lg font-medium text-gray-700 mb-3">DSY Consultancy</h1>
                            ...
                            <Link href="https://github.com/gvrv03/DSYConsultancy" className='  text-white bg-gray-800 w-fit px-2 py-1 mt-2 rounded-md flex gap-2 items-center ' >
                    ...
                    <div className=" border GlassCard h-full    rounded-md overflow-hidden">
                        ...
                        <div className=' p-5 ' >
                            <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Full Stack</h2>
                            <h1 className="title-font text-lg font-medium text-gray-700 mb-3">GoDigi</h1>
                            ...
                            <Link href="https://github.com/gvrv03/GoDigi" className='  text-white bg-gray-800 w-fit px-2 py-1 mt-2 rounded-md flex gap-2 items-center ' >
                                <i className='uil uil-github' />
                                <p className='text-xs  font-semibold '  >
                                    View Repositories
                                </p>
                    ...
                    <div className=" border GlassCard h-full    rounded-md overflow-hidden">
                        ...
                        <div className=' p-5 ' >
                            <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Full Stack</h2>
                            <h1 className="title-font text-lg font-medium text-gray-700 mb-3">Campus Plant Lense</h1>
                            ...
                            <Link href="https://github.com/gvrv03/CampusPlantLens" className='  text-white bg-gray-800 w-fit px-2 py-1 mt-2 rounded-md flex gap-2 items-center ' >
                                <i className='uil uil-github' />
                                <p className='text-xs  font-semibold '  >
                                    View Repositories
                                </p>
